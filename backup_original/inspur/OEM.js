...
const TRANSLATIONS = {
  ...
  en: {
    ...
    nav: [
      { name: 'About Inspur', url: 'https://inspur.com.vn/about/' },
      ...
      { name: 'Contact', url: 'https://inspur.com.vn/contact/' },
    ],
      ...
      <nav className={`fixed top-0 left-0 right-0 z-[100] transition-all duration-500 ${
        ...
        <div className="max-w-7xl mx-auto px-6 flex items-center justify-between">
          ...
          <div className="hidden lg:flex items-center gap-8">
            ...
            <button 
              onClick={() => window.location.href = 'https://inspur.com.vn/contact/'}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 md:gap-16 mb-20">
            ...
            <div className="text-center md:text-left">
              ...
              <ul className="space-y-4 text-slate-400 text-sm font-bold">
                ...
                <li><a href="https://inspur.com.vn/oem/" className="hover:text-white transition-colors">OEM Services</a></li>
              </ul>
            </div>
