...
const TRANSLATIONS = {
  vi: {
    ...
    nav: [
      { name: 'Về Inspur', url: 'https://inspur.com.vn/about/' },
      { name: 'Sản Phẩm', url: 'https://inspur.com.vn/san-pham/' },
      { name: 'Giải pháp', url: 'https://inspur.com.vn/giai-phap/' },
      { name: 'OEM', url: 'https://inspur.com.vn/oem/' },
      { name: 'Tin tức và sự kiện', url: 'https://inspur.com.vn/tin-tuc-va-su-kien/' },
      { name: 'Liên hệ', url: 'https://inspur.com.vn/contact/' },
    ],
    ...
    products: [
      {
        ...
        link: 'https://inspur.com.vn/san-pham/man-hinh-inspur/'
      },
      {
        id: 2,
        ...
        link: 'https://inspur.com.vn/san-pham/may-tinh-all-in-one/'
      },
      {
        id: 3,
  ...
  en: {
    ...
    nav: [
      { name: 'About us', url: 'https://inspur.com.vn/gioi-thieu/'},
      { name: 'Products', url: 'https://inspur.com.vn/san-pham/' },
      { name: 'Solutions', url: 'https://inspur.com.vn/giai-phap/' },
      { name: 'OEM', url: 'https://inspur.com.vn/oem/' },
      { name: 'Events', url: 'https://inspur.com.vn/tin-tuc-va-su-kien/' },
      { name: 'Contact us', url: 'https://inspur.com.vn/contact/' },
    ],
    ...
    products: [
      {
        ...
        img: './images/IIP270AF.png',
        link: 'https://inspur.com.vn/man-hinh-inspur/'
      },
      {
        id: 2,
        ...
        img: './images/UT238.png',
        link: 'https://inspur.com.vn/may-tinh-all-in-one/'
      },
      {
        id: 3,
...
const App = () => {
  ...
  useEffect(() => {
    ...
    // Favicon cho taskbar - ưu tiên ICO (hỗ trợ nhiều kích thước trong 1 file)
    // ICO là định dạng chuẩn và tốt nhất cho favicon
    setLinkTag('shortcut icon', faviconIco, null, 'image/x-icon', true);
    setLinkTag('icon', faviconIco, null, 'image/x-icon', true);
    
    // Fallback: Nếu không có ICO, dùng PNG với các kích thước chuẩn
    // Kích thước 16x16 và 32x32 là quan trọng nhất cho taskbar (không bị bể hình)
    setLinkTag('icon', faviconPng, '16x16', 'image/png');
    setLinkTag('icon', faviconPng, '32x32', 'image/png');
    setLinkTag('icon', faviconPng, '96x96', 'image/png');
    setLinkTag('icon', faviconPng, '192x192', 'image/png');
    setLinkTag('icon', faviconPng, '512x512', 'image/png');
    
    // Apple touch icon cho iOS (nên dùng PNG vuông, kích thước 180x180)
    setLinkTag('apple-touch-icon', faviconPng, '180x180', 'image/png');
  ...
  // Hàm mở Zalo chat
  const openZaloChat = () => {
    window.open('https://zalo.me/0703394824', '_blank');
  };

  // Hàm mở Zalo với tin nhắn mặc định
  const openZaloWithMessage = (message = '') => {
    const encodedMessage = encodeURIComponent(message);
    window.open(`https://zalo.me/0703394824?message=${encodedMessage}`, '_blank');
  };
  ...
  return (
    <div className="min-h-screen bg-slate-50 font-sans text-slate-900 selection:bg-[#0056b3] selection:text-white">
      ...
      <div className={`fixed top-0 right-0 w-[85%] max-w-sm h-full bg-white z-[200] transition-transform duration-500 ease-out lg:hidden shadow-2xl ${
        ...
        <div className="flex flex-col h-full">
          ...
          <div className="p-8 bg-slate-50 space-y-6">
            ...
            <button 
              onClick={() => {
                window.location.href = 'https://inspur.com.vn/oem/';
                setIsMenuOpen(false);
              }}
      ...
      <nav className={`fixed top-0 left-0 right-0 z-[100] transition-all duration-500 ${
        ...
        <div className="max-w-7xl mx-auto px-6 flex items-center justify-between">
          ...
          <div className="hidden lg:flex items-center gap-8">
            ...
            <button 
              onClick={() => window.location.href = 'https://inspur.com.vn/oem/'}
              ...
              return (
                ...
                >
                  ...
                  <div className="p-8 md:p-10 flex-1 flex flex-col">
                    ...
                    <button 
                      onClick={() => window.location.href = product.link || 'https://inspur.com.vn/contact/'}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 md:gap-16 mb-20">
            ...
            <div className="text-center md:text-left">
              ...
              <ul className="space-y-4 text-slate-400 text-sm font-bold">
                <li><a href="https://inspur.com.vn/san-pham/" className="hover:text-white transition-colors">Sản phẩm</a></li>
                <li><a href="https://inspur.com.vn/giai-phap/" className="hover:text-white transition-colors">Giải pháp</a></li>
                <li><a href="https://inspur.com.vn/tin-tuc-va-su-kien/" className="hover:text-white transition-colors">Tin tức và sự kiện</a></li>
              </ul>
            </div>
            ...
            <div className="text-center md:text-left">
              ...
              <ul className="space-y-4 text-slate-400 text-sm font-bold">
                <li><a href="https://inspur.com.vn/about/" className="hover:text-white transition-colors">Về chúng tôi</a></li>
                <li><a href="https://inspur.com.vn/contact/" className="hover:text-white transition-colors">Liên hệ</a></li>
                <li><a href="https://inspur.com.vn/contact/" className="hover:text-white transition-colors">Hỗ trợ kỹ thuật</a></li>
              </ul>
            </div>
            ...
            <div className="space-y-6 text-center md:text-left">
              ...
              <div className="flex flex-col gap-3 pt-4">
                ...
                <button 
                  ...
                  className="w-full md:w-auto flex items-center justify-center gap-3 px-6 py-3 bg-[#0084ff] text-white rounded-xl text-[11px] font-black uppercase tracking-widest hover:bg-[#0066cc] transition-all shadow-lg shadow-blue-500/20 active:scale-95"
                >
      ...
      <div className="fixed bottom-6 right-6 z-[90] flex flex-col gap-3">
        <button 
          onClick={openZaloChat}
          className="w-14 h-14 bg-[#0068ff] text-white rounded-full shadow-2xl hover:bg-[#0056cc] transition-all hover:scale-110 active:scale-95 flex items-center justify-center group relative"
          title="Nhắn tin Zalo"
        >
          <ZaloIcon className="w-7 h-7" />
          <span className="absolute right-full mr-3 px-3 py-1.5 bg-slate-900 text-white text-[10px] font-black uppercase tracking-widest rounded-lg opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap">
            Nhắn tin Zalo
          </span>
        </button>
        <button 
          onClick={openFacebookMessenger}
          className="w-14 h-14 bg-[#0084ff] text-white rounded-full shadow-2xl hover:bg-[#0066cc] transition-all hover:scale-110 active:scale-95 flex items-center justify-center group relative"
