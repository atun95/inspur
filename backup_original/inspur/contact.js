...
const App = () => {
  ...
  useEffect(() => {
    ...
    setLinkTag('icon', logoImageUrl, '16x16', 'image/jpeg');
    setLinkTag('icon', logoImageUrl, '32x32', 'image/jpeg');
    setLinkTag('icon', logoImageUrl, '96x96', 'image/jpeg');
    setLinkTag('apple-touch-icon', logoImageUrl, '180x180', 'image/jpeg');
    setLinkTag('icon', logoImageUrl, '192x192', 'image/jpeg');
    setLinkTag('icon', logoImageUrl, '512x512', 'image/jpeg');
    setLinkTag('shortcut icon', logoImageUrl, null, 'image/jpeg');
