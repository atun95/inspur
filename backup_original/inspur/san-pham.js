    ...
    products: [
      {
        ...
        img: './images/03.jpg',
        icon: MousePointer2,
        url: 'https://inspur.com.vn/san-pham/ai-mouse/'
      },
      {
        id: 2,
        category: 'Laptop',
      ...
      },
      {
        ...
        icon: Monitor,
        url: 'https://inspur.com.vn/san-pham/man-hinh-inspur/'
      },
      {
        id: 4,
        category: 'All-in-One',
...
const App = () => {
  ...
  const TextLogo = ({ light = false }) => (
    <div className="flex items-center group cursor-pointer" onClick={() => window.location.href = 'https://inspur.com.vn/'}>
      <img
        src="./images/logo4.jpg"
        alt="Inspur Logo"
        className="h-8 w-auto cursor-pointer"
        onClick={() => window.location.href = 'https://inspur.com.vn/'}
      />
    </div>
  );
            ...
            <div>
              ...
              <ul className="space-y-6">
                ...
                <li className="flex gap-4">
                  ...
                  <div className="text-sm text-slate-400 italic">0907865892</div>
                </li>
                <li className="flex gap-4">
