...
const App = () => {
  ...
  useEffect(() => {
    ...
    // Set favicon.ico as primary favicon
    const faviconUrl = '/favicon.ico';
    setFaviconTag('shortcut icon', faviconUrl, null, 'image/x-icon');
    setFaviconTag('icon', faviconUrl, null, 'image/x-icon');
    
    // Fallback PNG icons if needed
    const faviconPng = '/favicon.png';
    setFaviconTag('icon', faviconPng, '16x16', 'image/png');
    setFaviconTag('icon', faviconPng, '32x32', 'image/png');
    setFaviconTag('icon', faviconPng, '96x96', 'image/png');
    setFaviconTag('apple-touch-icon', faviconPng, '180x180', 'image/png');
    setFaviconTag('icon', faviconPng, '192x192', 'image/png');
    setFaviconTag('icon', faviconPng, '512x512', 'image/png');
